...
namespace Idp.Swiyu.Passkeys.Sts.Data.Migrations
{
    ...
    [Migration("20251229192506_Swiyu")]
    partial class Swiyu
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Idp.Swiyu.Passkeys.Sts.Models.SwiyuIdentity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Idp.Swiyu.Passkeys.Sts.Models.ApplicationUser", null)
                        .WithMany()
